...
def adjust_learning_rate(optimizer, epoch, args):
    ...
    if epoch == 0 or epoch % args.lr_decay != 0:
        return
    decay_ratio = args.lr_decay_ratio or 0.5  # decay ratio
    print(f"adjust_learning_rate() epoch={epoch}; decay_ratio:{decay_ratio}")
    if decay_ratio == 1:
        return
    for param_group in optimizer.param_groups:
        old_val = param_group['lr']
        new_val = old_val * decay_ratio
