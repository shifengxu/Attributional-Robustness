...
class WideResNet(nn.Module):
    def __init__(self, depth,widen_factor=1, dropRate=0.5, flatten = True ,
                 beta_value = 1.0 , stride = 1, final_feat_dim=640, num_classes=17):
        ...
        self.linear = (nn.Linear(final_feat_dim, num_classes))  # flower 17 categories
...
def WideResNet28_10( flatten = True , droprate = 0.1 , beta_value = 1.0, num_classes=17):
    return WideResNet(28,10,droprate,flatten , beta_value, num_classes=num_classes)